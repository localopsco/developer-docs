...
description: How to spin up ephemeral full-stack enviornments to test pull requests in isolation
---
...
<div style={{ position: 'relative', paddingBottom: '65.85%', height: 0 }}>
  <iframe
    src="https://www.loom.com/embed/cfc656d1e23343b3acc77f1acff1a209"
    frameBorder="0"
    allowFullScreen
...
Talk to us at support@localops.co and we can come up with alternate strategies to make 3rd party apps work in preview
services.
