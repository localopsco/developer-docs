...
<Note>For preview environments to work, the github user who is commiting on the pull request branch must be added to LocalOps as a user. And they must have linked their Github profile with LocalOps from inside Profile settings: https://console.localops.co/profile</Note>
