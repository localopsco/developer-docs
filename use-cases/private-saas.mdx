...
Follow instructions in [connecting cloud account](/connect-cloud/aws.md#to-your-customers-cloud-account) guide to get
your customer account connected with LocalOps.
