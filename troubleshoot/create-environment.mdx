...
AWS imposes limits on the number of resource that can be created for a specific type. For example, by default, only 5
Elastic IPs (EIPs) are allowed per AWS account per region. If this limit is reached, the Environment create operation
