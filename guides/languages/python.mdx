...
<Note>
Creating a `.dockerignore` file and adding folders like `node_modules` is must, since dependencies will be
...
Optionally you can have a seperate image to run your DB migrations. In production setup, it is advisable to have
seperate image to run DB migrations.
