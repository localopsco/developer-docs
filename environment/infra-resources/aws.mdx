---
title: View your app environment's resources
---
...
To view all the resources that belong to your app environment
...
2. Open the [AWS Resource Explorer](https://resource-explorer.console.aws.amazon.com/resource-explorer/home#/search)
   from AWS your console

3. Use a query such as tag.key:acmecorp.loc.env-id tag.value:627e8bb2-2667-46aa-943b-b93d5924fced to view all the
