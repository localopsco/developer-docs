...
1. Click on **App Environments** from the navigation pane on the left side to see the list of available App
   Environments.
2. To delete a App Environment, click on the App Environment that you want to delete and then select **Archive**.
3. Confirm deletion by typing the App Environment name. Then, click on **Archive** button to initiate App Environment
   deletion.
