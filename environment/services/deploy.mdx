...
If your github org doesn't allow direct git push on the branch, you can ask your team to raise pull requests (PRs)
targeting the configured branch name of the service. If you merge the PR, a new dpeloyment will start in LocalOps with
