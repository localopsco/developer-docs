...
<Tip>
  The Erlang-Distribution dashboard is most useful when your nodes are actually clustered. See
  [BEAM clustering](/environment/services/beam-clustering) for how to cluster your Elixir/Erlang services with a single
  `ops.json` key.
</Tip>
