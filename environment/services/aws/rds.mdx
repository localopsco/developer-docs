...
you've connected for the service. And add RDS instances as dependency, like below.
...
2. `prefix` - Alpha numeric string. Will be used as a prefix in name of your instance. Changing this string will replace
   the original instance with new instance.
