...
10. `parameters` - Optional list of DB parameter group settings to apply to the RDS instance. Each entry is an object
...
11. `exports` - Set of key value pairs. Keys are the ENVIRONMENT VARS we will pass to your code / containers. Values are
