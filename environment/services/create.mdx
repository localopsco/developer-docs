...
1. Navigate to the app environment where you want the service to run
2. Go to "Services" tab
3. Clik on "+ Add new service" tile
...
You can specify the file localtion within your repository where we can find the Dockefile. If the Dockerfile is present
...
This is to accomodate the case of mono-repos where you might have more than one component's codebase in the same git
repo.
...
:::tip Specifying max CPU and max Memory is a neat trick to catch memory leaks and restart containers. :::
...
deployment will get triggered. Learn more at [Deploy service](services/deploy.md) guide.
