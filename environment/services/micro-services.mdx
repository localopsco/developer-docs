...
You can login to LocalOps and create any number of app environments and any number of services within an app
environment. Services can be of type - `Web/External service` or `Internal service` to expose themselves for either
public usage (`External`) or private usage within your environment (`Internal`).
