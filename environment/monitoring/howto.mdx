...
To monitor an app environment, you need to make sure you have an environment that's up and running.

#### Steps to Monitor Your App Environment

- Click on **App Environments** from the navigation pane on the left side.
...
And that's it! Now you can keep an eye on how your app environment is performing.

### Monitoring New App Environment Creation

Once you've triggered the creation of the App Environment, operational logs will start appearing in the Ops view.
...
### Monitoring a New Release to an Existing App Environment
