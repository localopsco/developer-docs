...
Say you want to create a RDS database for your environment. Here is how you will do it in Terraform, OpenTofu or
Pulumi.
...
tags are exposed within environment Dashboard page.
