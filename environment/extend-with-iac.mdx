...
app environment - dev, stage, prod, beyond what LocalOps has provisioned for the same app environment.
...
Say you want to create a RDS database for your App environment. Here is how you will do it in Terraform, OpenTofu or
Pulumi.

### Using Terraform or OpenTofu

Here is how you can create an RDS database within the same private subnets and VPCs of the app environment using
...
resources in the cloud, analyse cost per app environment in Cost analysis console in the cloud account and more. These
tags are exposed within App environment Dashboard page.

<img src="./images/vpc-tags.png" />

When you extend app environments with custom cloud resources, you can attach the same tags so that you can see both the
...
app environment within LocalOps console. This is to ensure that all your additional cloud resources are deleted in full
