...
<CardGroup cols={2}>
  ...
  <Card title="Spin up new environment" icon="container-storage" href="/environments/create">
    Create a new environment (say test, staging, production etc.,)
  </Card>
  <Card title="Launch a new service" icon="rocket" href="/environments/services/create">
