...
<AccordionGroup>
  <Accordion title="Is there a lock-in? Will environments continue to run after I stop using LocalOps?">
    Yes. There is no lock-in at all. When you stop using LocalOps, environments are left as they are, in your cloud, for your team to start managing them. Check [how to eject](/environment/eject) to learn more.
  </Accordion>
