...
team can be customer facing to create app environments and make deployments. Administrator is of course the super admin
and can delete/create/update everything.

We will soon be releasing another role called "QA" to let them create internal app environments as they see fit. More on
