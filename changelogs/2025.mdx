...
From now, when you create a new service, you can trigger a new deployment directly from the same form. Earlier, this was a separate step after the service is created. This minor change allows devs to spin up the new service instantly without having to perform any other step. 
