...
We added two new commands that let you connect to the RDS Postgres shell directly from your dev laptop with 1 command. Without signing into bastion servers or any other step.
