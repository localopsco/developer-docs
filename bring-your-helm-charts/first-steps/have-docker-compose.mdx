...
Follow this guide to package your application as a Helm chart using the docker-compose.yaml file that you already have.
We will use a simple example containing an application connected to a PostgreSQL database.
...
2. Write a deployment object (kubernetes manifest) for each of the services from docker-compose.yaml file, in the
