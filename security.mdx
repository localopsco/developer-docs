...
**NIST & SOC2 alignment:** Our security controls align with industry standard NIST & SOC2 frameworks and span from hiring, software architecture & software development life cycle, software hosting, configuration & releases on the cloud, disaster recovery and more. 
...
6. **Recovery Time Objective (RTO):** All services can be recovered within 24 hours if there is a major incident.
7. **Incident Communication:** Internal communication tools (Slack) and backup communication tools are active all the time to escalate and recover from issues as soon as possible.
