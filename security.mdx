...
<Info>
  This document covers LocalOps SaaS version. 
  
  You can also run LocalOps in your cloud account for more privacy/control. Your team can manage the instance (self-hosted) or we can manage them remotely for you (BYOC). Talk with us at help@localops.co / https://go.localops.co/tour and we can get it running in just a few days.
</Info>
