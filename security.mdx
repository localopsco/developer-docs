...
LocalOps takes security seriously and is committed to safeguarding your accounts and data with state of the art security controls and best practices. Our security controls span from hiring, software architecture & software development life cycle, software hosting, configuration & releases on the cloud, disaster recovery and more. 
...
- **AWS Data Center Security Controls:** AWS data centers in our hosting region implement a variety of security measures to protect your data.
