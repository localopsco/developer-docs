...
AWS for example, security groups, disk encryption etc., are all enabled by default. For a detailed overview of all
built-in security controls, see the [Security Controls](/environment/security) guide.
